...
import 'package:flutter_wanandroid/net/exception/unauthorized_exception.dart';
  ...
  showErrorMessage(context, {String message}) {
    if (viewStateError != null || message != null) {
      if (viewStateError.isNetworkError) {
        message ??= AppLocalizations.of(context).viewStateMessageNetworkError;
      } else {
