...
import 'package:flutter_wanandroid/i18n/localization.dart';
import 'package:flutter_wanandroid/res/icon_fonts.dart';
  ...
  Widget build(BuildContext context) {
    ...
    switch (error.errorType) {
      ...
      case ErrorType.defaultError:
        ...
        defaultTitle = AppLocalizations.of(context).viewStateMessageError;
        break;
    }
...
class ViewStateUnAuthWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewStateWidget(
      ...
      title: message ?? AppLocalizations.of(context).viewStateMessageUnAuth,
      buttonText: buttonText,
      buttonTextData: AppLocalizations.of(context).viewStateButtonLogin,
    );
  }
}
...
class ViewStateUnAuthImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Hero(
      tag: 'loginLogo',
      child: LoadAssetImage("login_logo.png"),
    );
  }
}
