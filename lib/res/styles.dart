...
class TextStyles {
  ...
  static const TextStyle textBold15 =
      const TextStyle(fontSize: Dimens.font_sp15, fontWeight: FontWeight.bold);
  ...
  static const TextStyle textDarkGray14 = const TextStyle(
      ...
      color: Colours.dark_text_gray,
      fontWeight: FontWeight.normal);
  static const TextStyle textDarkGray16 = const TextStyle(
    fontSize: Dimens.font_sp16,
    color: Colours.dark_text_gray,
  );
  ...
  static const TextStyle textLightGray10 = const TextStyle(
      ...
      color: Colours.light_text_gray,
      fontWeight: FontWeight.normal);
  static const TextStyle textLightGray12 = const TextStyle(
      fontSize: Dimens.font_sp12,
      color: Colours.light_text_gray,
      fontWeight: FontWeight.normal);
  static const TextStyle textLightGray14 = const TextStyle(
      fontSize: Dimens.font_sp14,
      color: Colours.light_text_gray,
      fontWeight: FontWeight.normal);
